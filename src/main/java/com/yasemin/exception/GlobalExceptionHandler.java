...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DoktorHastaRandevuException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> doktorHAstaRandevuHandler(DoktorHastaRandevuException doktorHastaRandevuException){
        return new ResponseEntity<>(createErrorMessage(doktorHastaRandevuException,doktorHastaRandevuException.getErrorType()),
                doktorHastaRandevuException.getErrorType().getHttpStatus());
    }
